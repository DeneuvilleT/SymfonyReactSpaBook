 ...
 */
final class Version20240415200219 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE bookings ADD CONSTRAINT FK_7A853C35B671DE9B FOREIGN KEY (categories_cottage_id) REFERENCES categories_cottage (id)');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE bookings ADD CONSTRAINT FK_7A853C352B099F37 FOREIGN KEY (location_type_id) REFERENCES location_types (id) ON UPDATE NO ACTION ON DELETE NO ACTION');
